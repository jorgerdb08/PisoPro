    ...
    <div className="flex min-h-screen flex-col justify-between px-4 py-8 sm:py-12">
      <div className="space-y-6">
        ...
        <div className="space-y-2 pt-4 text-center">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-900 text-white shadow-xs">
        ...
        {claimError && (
          <div className="animate-in fade-in slide-in-from-top-2 flex items-center gap-2.5 rounded-xl border border-rose-200 bg-rose-50 p-3.5 text-xs text-rose-700">
        ...
        <div className="space-y-3">
          {profiles.length > 0 ? (
            ...
            <div className="text-slate-400 flex flex-col items-center justify-center space-y-2 py-12 text-center text-xs">
      ...
      <div className="pt-8 text-center">
        <div className="border-slate-200 bg-white text-slate-500 inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-[11px] shadow-xs">
